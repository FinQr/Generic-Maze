...
void About_Game()
{
    ...
    Ftext.menu_text_color = Color(237, 147, 0);
    Ftext.bord = 3;
    InitText(Titul, 60, 30, L"Персонаж появляется в районе центра лабиринта.\
        \nВыход из лабиринта в виде портала, который расположен в верхнем левом углу.\
        \n При истечение времени игрок проигрывает.\
        \n Клавиши, которые используются для передвижения персонажа:\
        \n (W, A, S, D) или клавиши стрелок", Ftext);
